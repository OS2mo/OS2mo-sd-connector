...
#    print(sd_connector.getProfession(institution_identifier))
    ...
    sd_connector = AsyncSDConnector(username, password)
    print(await sd_connector.getDepartment(institution_identifier))
    print(await sd_connector.getDepartmentParent("9848725d-2798-4600-9200-000006180002"))
    print(await sd_connector.getInstitution(None, institution_identifier))
    print(await sd_connector.getOrganization(institution_identifier))
    print(await sd_connector.getEmployment(institution_identifier))
    print(await sd_connector.getEmploymentChanged(institution_identifier))
    print(await sd_connector.getEmploymentChangedAtDate(institution_identifier))
    print(await sd_connector.getPerson(institution_identifier))
    print(await sd_connector.getPersonChangedAtDate(institution_identifier))
    print(await sd_connector.getProfession(institution_identifier))
    await sd_connector.aclose()
